function validate() {
  const team1 = document.forms["form"]["team1"].value;
  const points1 = document.forms["form"]["points1"].value;

  const team2 = document.forms["form"]["team2"].value;
  const points2 = document.forms["form"]["points2"].value;
